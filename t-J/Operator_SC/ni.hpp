#ifndef NISC_HPP_INCLUDED
#define NISC_HPP_INCLUDED
#include <iomanip>
#include <cmath>
#include <math.h> 
#include <complex>
...
pair<complex<double>, complex<double>> operators_SC::change_NI(int ii,int nn0,int f0)
{
    ...
    fog_down1=conj(evs_0(nn0,f0))*evs_0(nn0,0)*nni;
    //=======================================================//
    return  make_pair(fog_up1,fog_down1);
}
//=====================================================================================================================================================================//
void operators_SC::nni(int ii)
{
    char title0[150];
    //----------------------------------------------//
    ...
    path= createDirectory("../Data/SC/Ni");
    sprintf(title0,"../Data/SC/Ni/Ni_%d_%d_%d_%d_%lld_%lld_%lld_%d.dat",tut0,tut1,tut2,tut3,N,nup,ndown,ii); //| ==== Name | I
