#ifndef SJSKSC_HPP_INCLUDED
#define SJSKSC_HPP_INCLUDED
#include <iomanip>
#include <cmath>
#include <math.h> 
#include <complex>
...
//========================================================================================================================================//
//========================================================================================================================================//
pair<complex<double>, complex<double>> operators_SC::change_SJSK(int ii,int jj,int kk,int nn0,int f0)
{
    ...
    {        
        ...
        {  
            ...
            //========================================================================================================================================//
                ...
                //=================================================================//
                fog_down1=conj(evs_0(q,f0))*evs_0(nn0,0)*ssz*JJ(ii,jj)*JJ(ii,kk)*0.5;            
            //========================================================================================================================================//
        }
        //========================================================================================================================================//
        //========================================================================================================================================//
        ...
        {    
            ...
            q=find0(q);   // finding the new basis location
            //=================================================================//
            fog_down2=conj(evs_0(q,f0))*evs_0(nn0,0)*JJ(ii,jj)*JJ(ii,kk)*0.25;
...
void operators_SC::SjSk(int ii)
{
    ...
    path= createDirectory("../Data/SC/SXiSjSk");
    sprintf(title0,"../Data/SC/SXiSjSk/SXiSjSk_%d_%d_%d_%d_%lld_%lld_%lld_%d.dat",tut0,tut1,tut2,tut3,N,nup,ndown,ii); //| ==== Name | I
                ...
                for (int kk = 0;  kk<N; kk++)
                {
                    if (abs(JJ(ii,kk))>0)
                    {
                        for (int nei = ii+1; nei <= ii+longrange; nei++)
                        {
                            ...
                            if (abs(JJ(ii,jj))>0)
                            {
                                pair<complex<double>, complex<double>>fog=change_SJSK(ii,jj,kk,vup,f0);
                                fog_up+=fog.first;
                                fog_down+=fog.second; 
                            }
                            //============================================================//
