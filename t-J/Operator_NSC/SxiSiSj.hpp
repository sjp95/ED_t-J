#ifndef SXISISJ_HPP_INCLUDED
#define SXISISJ_HPP_INCLUDED
#include <iomanip>
#include <cmath>
#include <math.h> 
#include <complex>
...
//========================================================================================================================================//
//========================================================================================================================================//
pair<complex<double>, complex<double>> operators_NSC::change_SXISISJ(int ii,int jj,int nn0,int f0)
{
    ...
    if(upi(ii)+downi(ii)>0 && abs(ssz)>0)
    {
        ...
        if(aupi>adowni)
        {
            ...
            //=================================================================//
            fog_down1=conj(evs_down(q,f0))*evs_0(nn0)*ssz*JJ(ii,jj)*0.5;            
        }
        //========================================================================================================================================//
        if(aupi<adowni)
        {
            ...
            //=================================================================//
            fog_up1=conj(evs_up(q,f0))*evs_0(nn0)*ssz*JJ(ii,jj)*0.5;            
        }
        //========================================================================================================================================//
    }
    //========================================================================================================================================//
    ...
    {    
        ...
        if(aupi>adowni)
        {
            ...
            q=find_down(q);   // finding the new basis location
            //=================================================================//
            fog_down2=conj(evs_down(q,f0))*evs_0(nn0)*JJ(ii,jj)*0.25;
        ...
        if(aupi<adowni)
        {
            ...
            q=find_up(q);   // finding the new basis location
            //=================================================================//
            fog_up2=conj(evs_up(q,f0))*evs_0(nn0)*JJ(ii,jj)*0.25;
...
void operators_NSC::SxiSiSj(int ii)
{
    //-------------------------------------------------------------------------------------------------------------------------------
    //-------------------------------------------------------------------------------------------------------------------------------
    char title0[150];
    ...
    path= createDirectory("../Data/NSC/SXiSiSj");
    sprintf(title0,"../Data/NSC/SXiSiSj/SXiSiSj_%d_%d_%d_%d_%lld_%lld_%lld_%d.dat",tut0,tut1,tut2,tut3,N,nup,ndown,ii); //| ==== Name | I
          ...
          //cout<<" "<<endl;
            ...
            for (int nn0 = 0; nn0 < le0; nn0++)
            {
                ...
                for (int nei = ii+1; nei <= ii+longrange; nei++)
                {
                    ...
                    if (abs(JJ(ii,jj))>0)
                    {
                        pair<complex<double>, complex<double>>fog=change_SXISISJ(ii,jj,vup,f0);
                        fog_up+=fog.first;
                        fog_down+=fog.second;
                    }
                    //============================================================//
