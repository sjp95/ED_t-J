#ifndef POBOPP_HPP_INCLUDED
#define POBOPP_HPP_INCLUDED
#include <math.h>
#include <complex>
#include <Eigen/Dense>
#include <vector>
...
//=========================================================//
//=========================================================//
long long operators_NSC::fact(long long n)
{
  if (n == 0 || n == 1)
  return 1;
  else
...
//=========================================================//
long long operators_NSC:: nCr(long long n,long long r)
{
  if(n>=r)
  {
...
//==============================================//
                //== POB number ==//
//==============================================//
void operators_NSC::pob_up_n(int value)
{
    int j=N;
    int temp= value;
    upi=VectorXi ::Zero(N);
...
//==============================================//
                //== POB number ==//
//==============================================//
void operators_NSC::pob_down_n(int value)
{
    int j=N;
    int temp= value;
...
//=========================================================================//
int operators_NSC::find0(int target) 
{
    int left = 0;
...
//=========================================================================//
//=========================================================================//
int operators_NSC::find_up(int target) 
{
    int left = 0;
...
//=========================================================================//
//=========================================================================//
int operators_NSC::find_down(int target) 
{
    int left = 0;
