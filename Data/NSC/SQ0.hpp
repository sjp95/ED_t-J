...
void NSC_input::Sq0()
{
  ...
  //=========================================//
    ...
    { 
      ...
      char title0[150];
      //------------------------------------------------------------------------------------------
      sprintf(title0,"../Data/NSC/SX/SSX_%d_%d_%d_%d_%d_%d_%d.dat",ttt0,ttt1,jjt0,jjt1,N,nup,ndown); //| ==== Name | I
      ...
      //-------------------------------------------------------------------------------------------
      //char title0[100];
      bool tut=createDirectory("../Data/NSC/SX/SXQ");
      //-------------------------------------------------------------------------------------------
      char title1[150];
      sprintf(title1,"../Data/NSC/SX/SXQ/SSX_%d_%d_%d_%d_%d_%d_%d.dat",ttt0,ttt1,jjt0,jjt1,N,nup,ndown); //| ==== Name | I
